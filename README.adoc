...
----
┌──────────────────────────────────────┬───────────────────────────────────────┐
│ Kotlin is a modern but already       │ Kotlin is a modern but already mature │
│ mature programming language aimed to │ programming  language  aimed  to make │
│ make developers happier. It’s        │ developers   happier.  It’s  concise, │
│ concise, safe, interoperable with    │ safe,  interoperable  with  Java  and │
│ Java and other languages, and        │ other  languages,  and  provides many │
│ provides many ways to reuse code     │ ways  to reuse  code between multiple │
│ between multiple platforms for       │ platforms for productive programming. │
│ productive programming.              │                                       │
│                                      │ Pick it up to start building powerful │
│ Pick it up to start building         │ applications!                         │
